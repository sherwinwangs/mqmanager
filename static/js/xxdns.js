...
// Sweet Alert for Delete
function objectDeleteGet(obj, url, content, redirectTo) {
    function doDelete() {
        var body = {};
        var success = function () {
...
xxdns.checked = false;
xxdns.selected = {};
xxdns.initDataTable = function (options) {
    // options = {
    //    ele *: $('#dataTable_id'),
    ...
    table.on('select', function (e, dt, type, indexes) {
        ...
        xxdns.selected[$node.find('input.ipt_check').prop('id')] = true
    }).on('deselect', function (e, dt, type, indexes) {
        var $node = table[type](indexes).nodes().to$();
        $node.find('input.ipt_check').prop('checked', false);
        xxdns.selected[$node.find('input.ipt_check').prop('id')] = false
    }).on('draw', function () {
...
xxdns.initServerSideDataTable = function (options) {
    // options = {
    //    ele *: $('#dataTable_id'),
    //    ajax_url *: '{% url 'users:user-list-api' %}',
    //    columns *: [{data: ''}, ....],
